...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            // 버튼 클릭했을 때, 발생되는 이벤트 생성함(onclick 이벤트와 동일)
            $("#btnSend").on("click", function() {
                //Ajax 호출해서 글 등록하기
                $.ajax({
                    url : "/mail/sendMail",
                    type: "post", // 전송방식은 Post
                    dataType: "JSON", // 전송 결과는 JSON 타입으로 받기
            ...
            $("#btnMailList").on("click", function () {
                location.href = "/mail/mailList"; // 메일 리스트 이동
            })
...
<form id="f">
    ...
    <div>
        ...
        <button id="btnMailList" type="button">메일 리스트</button>
